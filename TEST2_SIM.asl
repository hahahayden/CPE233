...
(0035)                       001  || .EQU INSIDE_FOR_COUNT    = 0x01 ;
(0036)                       001  || .EQU MIDDLE_FOR_COUNT    = 0x01 ;
(0037)                       001  || .EQU OUTSIDE_FOR_COUNT   = 0x01 ;
(0038)                            || ;-----------------------------------------------------------------------|
(0039)                            || 
(0040)                            || .DSEG
(0041)                       000  || .ORG         0x00  
...
(0057)                            || 
(0058)                            || ;-HOLD-DELAY-1-----------------------------------------------------------
(0059)  CS-0x048  0x36101         || 		MOV     R1, OUTSIDE_FOR_COUNT
(0060)  CS-0x049  0x2C101  0x049  || OUTSIDE_FOR1: 	SUB     R1, 0x01
(0061)                            ||  
(0062)  CS-0x04A  0x36201         || 		MOV     R2, MIDDLE_FOR_COUNT
(0063)  CS-0x04B  0x2C201  0x04B  || MIDDLE_FOR1:  	SUB     R2, 0x01
(0064)                            ||              
(0065)  CS-0x04C  0x36301         || 		MOV     R3, INSIDE_FOR_COUNT
...
(0085)                            || 
(0086)                            || ;-HOLD-DELAY-2-----------------------------------------------------------
(0087)  CS-0x05A  0x36101         || 		MOV     R1, OUTSIDE_FOR_COUNT
(0088)  CS-0x05B  0x2C101  0x05B  || OUTSIDE_FOR2: 	SUB     R1, 0x01
(0089)                            ||  
(0090)  CS-0x05C  0x36201         || 		MOV     R2, MIDDLE_FOR_COUNT
(0091)  CS-0x05D  0x2C201  0x05D  || MIDDLE_FOR2:  	SUB     R2, 0x01
(0092)                            ||              
(0093)  CS-0x05E  0x36301         || 		MOV     R3, INSIDE_FOR_COUNT
...
(0113)                            || 
(0114)                            || ;-HOLD-DELAY-3-----------------------------------------------------------
(0115)  CS-0x06C  0x36101         || 		MOV     R1, OUTSIDE_FOR_COUNT
(0116)  CS-0x06D  0x2C101  0x06D  || OUTSIDE_FOR3: 	SUB     R1, 0x01
(0117)                            ||  
(0118)  CS-0x06E  0x36201         || 		MOV     R2, MIDDLE_FOR_COUNT
(0119)  CS-0x06F  0x2C201  0x06F  || MIDDLE_FOR3:  	SUB     R2, 0x01
(0120)                            ||              
(0121)  CS-0x070  0x36301         || 		MOV     R3, INSIDE_FOR_COUNT
...
(0141)                            || 
(0142)                            || ;-HOLD-DELAY-4-----------------------------------------------------------
(0143)  CS-0x07E  0x36101         || 		MOV     R1, OUTSIDE_FOR_COUNT
(0144)  CS-0x07F  0x2C101  0x07F  || OUTSIDE_FOR4: 	SUB     R1, 0x01
(0145)                            ||  
(0146)  CS-0x080  0x36201         || 		MOV     R2, MIDDLE_FOR_COUNT
(0147)  CS-0x081  0x2C201  0x081  || MIDDLE_FOR4:  	SUB     R2, 0x01
(0148)                            ||              
(0149)  CS-0x082  0x36301         || 		MOV     R3, INSIDE_FOR_COUNT
...
(0169)                            || 
(0170)                            || ;-HOLD-DELAY-5-----------------------------------------------------------
(0171)  CS-0x090  0x36101         || 		MOV     R1, OUTSIDE_FOR_COUNT
(0172)  CS-0x091  0x2C101  0x091  || OUTSIDE_FOR5: 	SUB     R1, 0x01
(0173)                            ||  
(0174)  CS-0x092  0x36201         || 		MOV     R2, MIDDLE_FOR_COUNT
(0175)  CS-0x093  0x2C201  0x093  || MIDDLE_FOR5:  	SUB     R2, 0x01
(0176)                            ||              
(0177)  CS-0x094  0x36301         || 		MOV     R3, INSIDE_FOR_COUNT
...
-- Directives: .EQU
------------------------------------------------------------ 
INSIDE_FOR_COUNT 0x001   (0035)  ||  0065 0093 0121 0149 0177 
LED_PORT       0x040   (0031)  ||  0055 0083 0111 0139 0167 0189 
MIDDLE_FOR_COUNT 0x001   (0036)  ||  0062 0090 0118 0146 0174 
OUTSIDE_FOR_COUNT 0x001   (0037)  ||  0059 0087 0115 0143 0171 
