...
(0023)                       001  || .EQU INSIDE_FOR_COUNT    = 0x01
(0024)                       001  || .EQU MIDDLE_FOR_COUNT    = 0x01
(0025)                       001  || .EQU OUTSIDE_FOR_COUNT   = 0x01
(0026)                            || 
...
(0042)                     0x042  || testAND:
(0043)                            || ;----------------------------Hold-----------------------------------
(0044)  CS-0x042  0x36101         ||               MOV     R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0045)  CS-0x043  0x2C101  0x043  || outside_for0: SUB     R1, 0x01
(0046)                            || 
(0047)  CS-0x044  0x36201         ||              MOV     R2, MIDDLE_FOR_COUNT   ;set middle for loop count
(0048)  CS-0x045  0x2C201  0x045  || middle_for0:  SUB     R2, 0x01
(0049)                            ||              
(0050)  CS-0x046  0x36301         ||              MOV     R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0066)                     0x052  || testOR:
(0067)                            || ;----------------------------Hold-----------------------------------
(0068)  CS-0x052  0x36101         ||               MOV     R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0069)  CS-0x053  0x2C101  0x053  || outside_for1: SUB     R1, 0x01
(0070)                            || 
(0071)  CS-0x054  0x36201         ||              MOV     R2, MIDDLE_FOR_COUNT   ;set middle for loop count
(0072)  CS-0x055  0x2C201  0x055  || middle_for1:  SUB     R2, 0x01
(0073)                            ||              
(0074)  CS-0x056  0x36301         ||              MOV     R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0090)                     0x062  || testEXOR:		
(0091)                            || ;----------------------------Hold-----------------------------------
(0092)  CS-0x062  0x36101         ||              MOV     R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0093)  CS-0x063  0x2C101  0x063  || outside_for2: SUB     R1, 0x01
(0094)                            || 
(0095)  CS-0x064  0x36201         ||             MOV     R2, MIDDLE_FOR_COUNT   ;set middle for loop count
(0096)  CS-0x065  0x2C201  0x065  || middle_for2:  SUB     R2, 0x01
(0097)                            ||              
(0098)  CS-0x066  0x36301         ||              MOV     R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0115)                     0x072  || testLSL:		
(0116)                            || ;----------------------------Hold-----------------------------------
(0117)  CS-0x072  0x36101         ||              MOV     R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0118)  CS-0x073  0x2C101  0x073  || outside_for3: SUB     R1, 0x01
(0119)                            || 
(0120)  CS-0x074  0x36201         ||              MOV     R2, MIDDLE_FOR_COUNT   ;set middle for loop count
(0121)  CS-0x075  0x2C201  0x075  || middle_for3:  SUB     R2, 0x01
(0122)                            ||              
(0123)  CS-0x076  0x36301         ||              MOV     R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0138)                     0x082  || testLSR:	
(0139)                            || ;----------------------------Hold-----------------------------------
(0140)  CS-0x082  0x36101         ||              MOV     R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0141)  CS-0x083  0x2C101  0x083  || outside_for4: SUB     R1, 0x01
(0142)                            || 
(0143)  CS-0x084  0x36201         ||              MOV     R2, MIDDLE_FOR_COUNT   ;set middle for loop count
(0144)  CS-0x085  0x2C201  0x085  || middle_for4:  SUB     R2, 0x01
(0145)                            ||              
(0146)  CS-0x086  0x36301         ||              MOV     R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
-- Directives: .EQU
------------------------------------------------------------ 
INSIDE_FOR_COUNT 0x001   (0023)  ||  0050 0074 0098 0123 0146 
LED_PORT       0x040   (0030)  ||  0041 0164 0169 0174 0179 0184 
MIDDLE_FOR_COUNT 0x001   (0024)  ||  0047 0071 0095 0120 0143 
OUTSIDE_FOR_COUNT 0x001   (0025)  ||  0044 0068 0092 0117 0140 
