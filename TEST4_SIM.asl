...
(0050)                            ||  
(0051)                       001  || .EQU INSIDE_FOR_COUNT  = 0x01   ; These three contestants set the
(0052)                       001  || .EQU MIDDLE_FOR_COUNT  = 0x01   ; amount of delay between each test.
(0053)                       001  || .EQU OUTSIDE_FOR_COUNT = 0x01   ; Current time delay is about 503 mS.
...
(0091)                            || 
(0092)                            || ; Delay ----------------------------------------------------------------
(0093)  CS-0x054  0x36101         ||               MOV R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0094)  CS-0x055  0x2C101  0x055  || outside_one:  SUB R1, 0x01
(0095)  CS-0x056  0x36201         ||               MOV R2, MIDDLE_FOR_COUNT	 ;set middle for loop count
(0096)  CS-0x057  0x2C201  0x057  || middle_one:   SUB R2, 0x01
(0097)  CS-0x058  0x36301         ||               MOV R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0112)                            || 
(0113)                            || ; Delay ----------------------------------------------------------------
(0114)  CS-0x066  0x36101         ||               MOV R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0115)  CS-0x067  0x2C101  0x067  || outside_two:  SUB R1, 0x01
(0116)  CS-0x068  0x36201         ||               MOV R2, MIDDLE_FOR_COUNT	 ;set middle for loop count
(0117)  CS-0x069  0x2C201  0x069  || middle_two:   SUB R2, 0x01
(0118)  CS-0x06A  0x36301         ||               MOV R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0136)                            || 
(0137)                            || ; Delay ----------------------------------------------------------------
(0138)  CS-0x074  0x36101         ||               MOV R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0139)  CS-0x075  0x2C101  0x075  || outside_tre:  SUB R1, 0x01
(0140)  CS-0x076  0x36201         ||               MOV R2, MIDDLE_FOR_COUNT	 ;set middle for loop count
(0141)  CS-0x077  0x2C201  0x077  || middle_tre:   SUB R2, 0x01
(0142)  CS-0x078  0x36301         ||               MOV R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0154)                            || 
(0155)                            || ; Delay ----------------------------------------------------------------
(0156)  CS-0x082  0x36101         ||               MOV R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0157)  CS-0x083  0x2C101  0x083  || outside_for:  SUB R1, 0x01
(0158)  CS-0x084  0x36201         ||               MOV R2, MIDDLE_FOR_COUNT	 ;set middle for loop count
(0159)  CS-0x085  0x2C201  0x085  || middle_for:   SUB R2, 0x01
(0160)  CS-0x086  0x36301         ||               MOV R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0172)                            || 
(0173)                            || ; Delay ----------------------------------------------------------------
(0174)  CS-0x090  0x36101         ||               MOV R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0175)  CS-0x091  0x2C101  0x091  || outside_fiv:  SUB R1, 0x01
(0176)  CS-0x092  0x36201         ||               MOV R2, MIDDLE_FOR_COUNT	 ;set middle for loop count
(0177)  CS-0x093  0x2C201  0x093  || middle_fiv:   SUB R2, 0x01
(0178)  CS-0x094  0x36301         ||               MOV R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0190)                            || 
(0191)                            || ; Delay ----------------------------------------------------------------
(0192)  CS-0x09E  0x36101         ||               MOV R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0193)  CS-0x09F  0x2C101  0x09F  || outside_six:  SUB R1, 0x01
(0194)  CS-0x0A0  0x36201         ||               MOV R2, MIDDLE_FOR_COUNT	 ;set middle for loop count
(0195)  CS-0x0A1  0x2C201  0x0A1  || middle_six:   SUB R2, 0x01
(0196)  CS-0x0A2  0x36301         ||               MOV R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
(0212)                            || 
(0213)                            || ; Delay ----------------------------------------------------------------
(0214)  CS-0x0CC  0x36101         ||               MOV R1, OUTSIDE_FOR_COUNT  ;set outside for loop count
(0215)  CS-0x0CD  0x2C101  0x0CD  || outside_sev:  SUB R1, 0x01
(0216)  CS-0x0CE  0x36201         ||               MOV R2, MIDDLE_FOR_COUNT	 ;set middle for loop count
(0217)  CS-0x0CF  0x2C201  0x0CF  || middle_sev:   SUB R2, 0x01
(0218)  CS-0x0D0  0x36301         ||               MOV R3, INSIDE_FOR_COUNT   ;set inside for loop count
...
B7_MASK        0x080   (0049)  ||  
BTN_PORT       0x0FF   (0035)  ||  
INSIDE_FOR_COUNT 0x001   (0051)  ||  0097 0118 0142 0160 0178 0196 0218 
LED_PORT       0x040   (0034)  ||  0090 0111 0135 0153 0171 0189 0211 
MIDDLE_FOR_COUNT 0x001   (0052)  ||  0095 0116 0140 0158 0176 0194 0216 
OUTSIDE_FOR_COUNT 0x001   (0053)  ||  0093 0114 0138 0156 0174 0192 0214 
