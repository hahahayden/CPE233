...
(0491)                            || 
(0492)                            ||  
(0493)  CS-0x174  0x37D01  0x174  || pause:	     MOV     R29, time_OUTSIDE_FOR_COUNT  ;set outside for loop count
(0494)  CS-0x175  0x2DD01  0x175  || outside_for: SUB     R29, 0x01
(0495)                            || 
(0496)  CS-0x176  0x37C01         || 			 MOV     R28, time_MIDDLE_FOR_COUNT   ;set middle for loop count
(0497)  CS-0x177  0x2DC01  0x177  || middle_for: SUB     R28, 0x01
(0498)                            || 			 
(0499)  CS-0x178  0x37B01         || 			 MOV     R27, time_INSIDE_FOR_COUNT   ;set inside for loop count
...
TIME_INSIDE_FOR_COUNT 0x001   (0001)  ||  0499 
TIME_MIDDLE_FOR_COUNT 0x001   (0002)  ||  0496 
TIME_OUTSIDE_FOR_COUNT 0x001   (0003)  ||  0493 
