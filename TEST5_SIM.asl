...
(0006)                       001  || .EQU Top_Counter = 0x01			;
(0007)                       001  || .EQU Mid_Counter = 0x01			;
(0008)                       001  || .EQU Lower_Counter = 0x01		;
...
(0032)  CS-0x047  0x36101         || 		MOV  R1,Top_Counter
(0033)  CS-0x048  0x2C101  0x048  || Top_loop1:	SUB  R1,0x01
(0034)                            || 		
(0035)  CS-0x049  0x36201         || 		MOV  R2,Mid_Counter
(0036)  CS-0x04A  0x2C201  0x04A  || Mid_loop1:	SUB  R2,0x01
(0037)                            || 
(0038)  CS-0x04B  0x36301         || 		MOV  R3,Lower_Counter	
...
(0058)  CS-0x059  0x36101         || 		MOV  R1,Top_Counter
(0059)  CS-0x05A  0x2C101  0x05A  || Top_loop2:	SUB  R1,0x01
(0060)                            || 		
(0061)  CS-0x05B  0x36201         || 		MOV  R2,Mid_Counter
(0062)  CS-0x05C  0x2C201  0x05C  || Mid_loop2:	SUB  R2,0x01
(0063)                            || 
(0064)  CS-0x05D  0x36301         || 		MOV  R3,Lower_Counter	
...
(0084)  CS-0x06B  0x36101         || 		MOV  R1,Top_Counter
(0085)  CS-0x06C  0x2C101  0x06C  || Top_loop3:	SUB  R1,0x01
(0086)                            || 		
(0087)  CS-0x06D  0x36201         || 		MOV  R2,Mid_Counter
(0088)  CS-0x06E  0x2C201  0x06E  || Mid_loop3:	SUB  R2,0x01
(0089)                            || 
(0090)  CS-0x06F  0x36301         || 		MOV  R3,Lower_Counter	
...
(0110)  CS-0x07D  0x36101         || 		MOV  R1,Top_Counter
(0111)  CS-0x07E  0x2C101  0x07E  || Top_loop4:	SUB  R1,0x01
(0112)                            || 		
(0113)  CS-0x07F  0x36201         || 		MOV  R2,Mid_Counter
(0114)  CS-0x080  0x2C201  0x080  || Mid_loop4:	SUB  R2,0x01
(0115)                            || 
(0116)  CS-0x081  0x36301         || 		MOV  R3,Lower_Counter	
...
(0137)  CS-0x090  0x36101         || 		MOV  R1,Top_Counter
(0138)  CS-0x091  0x2C101  0x091  || Top_loop5:	SUB  R1,0x01
(0139)                            || 		
(0140)  CS-0x092  0x36201         || 		MOV  R2,Mid_Counter
(0141)  CS-0x093  0x2C201  0x093  || Mid_loop5:	SUB  R2,0x01
(0142)                            || 
(0143)  CS-0x094  0x36301         || 		MOV  R3,Lower_Counter	
...
(0164)  CS-0x0A3  0x36101         || 		MOV  R1,Top_Counter
(0165)  CS-0x0A4  0x2C101  0x0A4  || Top_loop6:	SUB  R1,0x01
(0166)                            || 		
(0167)  CS-0x0A5  0x36201         || 		MOV  R2,Mid_Counter
(0168)  CS-0x0A6  0x2C201  0x0A6  || Mid_loop6:	SUB  R2,0x01
(0169)                            || 
(0170)  CS-0x0A7  0x36301         || 		MOV  R3,Lower_Counter	
...
(0191)  CS-0x0B6  0x36101         || 		MOV  R1,Top_Counter
(0192)  CS-0x0B7  0x2C101  0x0B7  || Top_loop7:	SUB  R1,0x01
(0193)                            || 		
(0194)  CS-0x0B8  0x36201         || 		MOV  R2,Mid_Counter
(0195)  CS-0x0B9  0x2C201  0x0B9  || Mid_loop7:	SUB  R2,0x01
(0196)                            || 
(0197)  CS-0x0BA  0x36301         || 		MOV  R3,Lower_Counter	
...
(0218)  CS-0x0C9  0x36101         || 		MOV  R1,Top_Counter
(0219)  CS-0x0CA  0x2C101  0x0CA  || Top_loop8:	SUB  R1,0x01
(0220)                            || 		
(0221)  CS-0x0CB  0x36201         || 		MOV  R2,Mid_Counter
(0222)  CS-0x0CC  0x2C201  0x0CC  || Mid_loop8:	SUB  R2,0x01
(0223)                            || 
(0224)  CS-0x0CD  0x36301         || 		MOV  R3,Lower_Counter	
...
LOWER_COUNTER  0x001   (0008)  ||  0038 0064 0090 0116 0143 0170 0197 0224 
MID_COUNTER    0x001   (0007)  ||  0035 0061 0087 0113 0140 0167 0194 0221 
...
TOP_COUNTER    0x001   (0006)  ||  0032 0058 0084 0110 0137 0164 0191 0218 
