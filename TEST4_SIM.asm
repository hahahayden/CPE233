...
.EQU INSIDE_FOR_COUNT  = 0x01   ; These three contestants set the
.EQU MIDDLE_FOR_COUNT  = 0x01   ; amount of delay between each test.
.EQU OUTSIDE_FOR_COUNT = 0x01   ; Current time delay is about 503 mS.
